...
/**
 * Implements the Scraper interface for extracting product data from PetSmart's website. This class
 * handles the generation of URLs, fetching of the web page, and parsing the HTML content.
 */
public class PetSmartScraper implements Scraper {
  ...
  public void parseResults(Document doc, String brand, String item) {
    ...
    for (int i = 0; i < itemTitles.size(); i++) {
      ...
      if (title.text().toLowerCase().contains(item.toLowerCase()) && title.text().toLowerCase()
